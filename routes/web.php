...
Route::resource('habis', 'HabispakaiController');
Route::resource('pengembalian', 'PengembalianController');
Route::resource('mutasi', 'MutasiController');
Route::resource('opname', 'BarangopnameController');
Route::resource('b_keluar', 'BarangkeluarController');
Route::resource('non_aktif', 'BarangnonaktifController');
Route::resource('penghapusan_barang', 'PenghapusanbarangController');
Route::resource('perbaikan_barang', 'PerbaikanbarangController');
